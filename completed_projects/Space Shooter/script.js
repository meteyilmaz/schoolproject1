...
const shootSound = new Audio("./sounds/laserSound1.mp3");
const explosionSound = new Audio("./sounds/explosionSound1.mp3");
...
function createPlayer() {
    ...
    playerImage.src = "./images/spaceship1.png";
...
function shoot() {
    ...
    bullet.src = "./images/spaceshipBullet1.png";
...
function createEnemys() {
    ...
    function createEnemy() {
        ...
        enemyImage.src = "./images/meteorite1" + ".png";
