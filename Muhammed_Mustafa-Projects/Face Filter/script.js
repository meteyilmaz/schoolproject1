...
let moustacheNameList = ["moustache1", "moustache2", "moustache3", "moustache4", "moustache5", "moustache6", "moustache7", "moustache8", "moustache9", "moustache10", "moustache11", "moustache12"];
let glassesNameList = ["glasses1", "glasses2", "glasses3"];
let imageNameList = [...moustacheNameList, ...glassesNameList];

let image = new Image();
image.src = `./Images/${imageNameList[Math.floor(Math.random() * imageNameList.length)]}.png`;
